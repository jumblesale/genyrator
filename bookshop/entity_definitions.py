...
from genyrator import (
    create_entity, create_column, TypeOption, create_identifier_column, create_relationship,
    JoinOption
)
...
entities = [book_entity, author_entity, review_entity, genre_entity, book_genre_entity]
...
if __name__ == '__main__':
    schema = create_bookshop_schema(entities)
    write_app(schema)
