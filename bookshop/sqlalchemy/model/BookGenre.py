...
class BookGenre(db.Model):  # type: ignore
    ...
    book_id =       db.Column(UUIDType, db.ForeignKey('book.book_id'), nullable=True)  # noqa: E501
    genre_id =      db.Column(UUIDType, db.ForeignKey('genre.genre_id'), nullable=True)  # noqa: E501
